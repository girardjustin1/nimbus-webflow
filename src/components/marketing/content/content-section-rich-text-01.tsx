                ...
                <div className="mx-auto max-w-prose md:max-w-180">
                    <div className="mx-auto prose md:prose-lg">
                        ...
                        <p>
                            ...
                            montes, sit sit. Tellus aliquam enim urna, etiam. Mauris{" "}
                        ...
                        <div className="not-prose my-10 rounded-2xl bg-secondary px-5 py-6 text-lg text-tertiary md:my-12 md:p-8 [&>p+p]:mt-4.5">
                    ...
                    <div className="-mt-px flex flex-col items-start justify-between gap-y-8 border-t border-secondary pt-6 md:flex-row">
                        ...
                        <div className="flex gap-3">
                            ...
                            <Button color="secondary" size="md" iconLeading={<Facebook className="size-5 text-fg-quaternary" />} />
                            <Button color="secondary" size="md" iconLeading={<LinkedIn className="size-5 text-fg-quaternary" />} />
                        </div>
                    </div>
                </div>
            </div>
