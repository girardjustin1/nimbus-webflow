...
/** Prebid article, enriched with a checklist, key-takeaway, and quote woven between the copy. */
const enriched03: NimbusArticle = {
    ...nimbusArticles[3],
    body: [
        {
            type: "paragraph",
...
const meta = {
    title: "Blog Article Templates/04",
...
export const Enriched: Story = { name: "Enriched (with sections)", args: { article: enriched03 } };
