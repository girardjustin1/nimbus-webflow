...
/**
 * Blog Article Template 05, rendered with each of the four real Nimbus articles
 * to see how the template adapts to actual content.
 */
const meta = {
    title: "Blog Layouts/Blog Article Template/05",
    component: BlogPost05,
    parameters: { layout: "fullscreen" },
} satisfies Meta<typeof BlogPost05>;
