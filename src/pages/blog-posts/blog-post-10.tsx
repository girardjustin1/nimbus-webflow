...
const ContentLargeImage02 = ({ article }: { article: NimbusArticle }) => {
...
const BlogPost10 = ({ article = nimbusArticles[0] }: { article?: NimbusArticle }) => {
    return (
        <div className="bg-[#f9f7f3]">

            <NimbusHeader />

            <ContentLargeImage02 article={article} />
